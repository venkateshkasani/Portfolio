...
const CardsComponent = () => {
  ...
  return (
    <section className='md:px-0 sm:pl-2 pl-0 mx-4 relative'>
     ...
     <div className='text-white w-[100vw] pt-2 px-2 sm:px-4 md:px-7 mb-7'>
        <p id='intro1' className='text-left md:text-center font-mono my-5 text-slate-600 text-xl sm:text-2xl md:text-4xl lg:text-5xl font-semibold'>Hey there!!</p>
        <div className="flex  items-start gap-2">
          <img className='rounded-full hidden md:inline w-10 h-10 mt-2 md:w-30 md:h-30' src='/img/profile.jpg' />
          <p id='intro2' className='intro font-mono text-start md:text-center text-wrap text-xl sm:text-2xl md:text-3xl lg:text-5xl text-slate-500'></p>
        </div>
    </div>
    <div>
    </div>
